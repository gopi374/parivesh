...
import { Leaf, User, Mail, Lock, Phone, Building2 } from 'lucide-react';
                        ...
                        <form onSubmit={handleRegister} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="firstName" placeholder="John" className="pl-10 h-12 border-muted" required />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="lastName">Last Name</Label>
                                    <Input id="lastName" placeholder="Doe" className="h-12 border-muted" required />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="orgName" placeholder="Green Energy Solutions Pvt Ltd" className="pl-10 h-12 border-muted" required />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="email" type="email" placeholder="john@company.com" className="pl-10 h-12 border-muted" required />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="phone" type="tel" placeholder="+91 XXXXX XXXXX" className="pl-10 h-12 border-muted" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <Lock className="absolute left-3 top-3.5 h-5 w-5 text-muted-foreground" />
                                        <Input id="confirmPassword" type="password" className="pl-10 h-12 border-muted" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <Button type="submit" className="w-full h-12 text-lg bg-primary hover:bg-primary/90 mt-4 shadow-lg shadow-primary/20">
                                Create Account
                            </Button>
                        </form>
                    </CardContent>
