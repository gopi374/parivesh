            ...
            <div className="bg-primary text-white py-1.5 text-[10px] md:text-xs">
                <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <img alt="Indian Flag" src="https://upload.wikimedia.org/wikipedia/en/4/41/Flag_of_India.svg" className="h-3 w-auto" />
            ...
            <div className="border-b bg-white py-4">
                <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex items-center gap-8">
                        <img alt="LiFE Logo" src="https://parivesh.nic.in/assests/img/Lifelogo.svg" className="h-10 opacity-80 hover:opacity-100 transition-opacity" />
                        <img alt="Azadi Logo" src="https://parivesh.nic.in/assests/img/azadi-ka-amrit-mahotsav.svg" className="h-10 opacity-80 hover:opacity-100 transition-opacity" />
                        <img alt="Emblem" src="https://parivesh.nic.in/assests/img/Emblem_of_India.svg" className="h-10 opacity-80 hover:opacity-100 transition-opacity" />
                    </div>
                </div>
            </div>
